...
class Angle_Calc_Left_KNEE:
    ...
    def process(self, frame, isStartSet, evaluation):
        ...
        try:
            ...
            # Get coordinates
            shoulder = [self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_HIP.value].x,
                        self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_HIP.value].y]
            elbow = [self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_KNEE.value].x,
                     self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_KNEE.value].y]
            wrist = [self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_ANKLE.value].x,
                     self.landmarks[mp.solutions.pose.PoseLandmark.RIGHT_ANKLE.value].y]
