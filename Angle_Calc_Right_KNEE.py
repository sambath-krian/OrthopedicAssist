...
class Angle_Calc_Right_KNEE:
    ...
    def process(self, frame, isStartSet, evaluation):
        ...
        try:
            ...
            # Get coordinates
            shoulder = [self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_HIP.value].x,
                        self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_HIP.value].y]
            elbow = [self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_KNEE.value].x,
                     self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_KNEE.value].y]
            wrist = [self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_ANKLE.value].x,
                     self.landmarks[mp.solutions.pose.PoseLandmark.LEFT_ANKLE.value].y]
